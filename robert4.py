        ...
        if _0 == '3':
                ...
                for _ in range(len(yxc)):
                        ...
                        try:
                                x = ___.split(' ')
                                with open(_2,'a') as o_:
                                        o_.write(__+':'+x[0].upper()+'123\n')
                                        o_.write(__+':'+x[0].upper()+'1234\n')
                                        o_.write(__+':'+x[0].upper()+'12345\n')
                                        o_.write(__+':'+x[0].upper()+'098\n')
                                        o_.write(__+':'+x[0].upper()+'321\n')
                                        o_.write(__+':'+x[0].upper()+'098\n')
                                        o_.write(__+':'+x[0].upper()+'099\n')
                                        o_.write(__+':'+x[0].upper()+'2000\n')
                                        o_.write(__+':'+x[0].upper()+'98\n')
                                        o_.write(__+':'+x[0].upper()+'99\n')
                                        o_.write(__+':'+x[0].upper()+'20\n')
                                        o_.write(__+':'+x[0].upper()+'21\n')
                                        o_.write(__+':'+x[0].upper()+'17\n')
                                        o_.write(__+':'+x[0].upper()+'18\n')
                                        o_.write(__+':'+x[0].upper()+'19\n')
                        except:
                                with open(_2,'a') as o_:
